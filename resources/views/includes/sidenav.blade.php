...
<div class="body-left d-none d-md-none d-lg-block d-xl-block">
    <div class="sidenav">
        <ul class="list-group">
            ...
            {{--@endif--}}
            <li class="list-group-item {{ request()->is('products') ? 'active' : '' }} {{ request()->is('products/*') ? 'active' : '' }}">
                <a href="/products">
                    <div class="icon">
                ...
                <div class="arrow d-none {{ request()->is('products') ? 'd-md-none d-lg-block d-xl-block' : '' }} {{ request()->is('products/*') ? 'd-md-none d-lg-block d-xl-block' : '' }}"></div>
            </li>
            <li class="list-group-item {{ request()->is('transactions') ? 'active' : '' }} {{ request()->is('transactions/*') ? 'active' : '' }}">
                <a href="/transactions">
                    <div class="icon">
                ...
                <div class="arrow d-none {{ request()->is('transactions') ? 'd-md-none d-lg-block d-xl-block' : '' }} {{ request()->is('transactions/*') ? 'd-md-none d-lg-block d-xl-block' : '' }}"></div>
            </li>
            ...
            {{--@if(Auth::user()->type == 'admin')--}}
                ...
                <li class="list-group-item {{ request()->is('users') ? 'active' : '' }} {{ request()->is('users/*') ? 'active' : '' }}">
                    <a href="/users">
                        <div class="icon">
                    ...
                    <div class="arrow d-none {{ request()->is('users') ? 'd-md-none d-lg-block d-xl-block' : '' }} {{ request()->is('users/*') ? 'd-md-none d-lg-block d-xl-block' : '' }}"></div>
                </li>
            {{--@endif--}}
            @guest
